...
To be entirely sure that your backup is correct, launch a completely new, separate yagna node from scratch on another machine and [verify that it's possible to restore your wallet](./wallet-restore.md.md) using this newly created keystore file.
